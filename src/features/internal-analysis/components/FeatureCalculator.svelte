  ...
  const TUTORIAL_STEPS: TutorialStep[] = [
    {
      ...
      color: 'green',
      icon: `${base}/feature_icons/increase_revenue.png`,
      examples: [
        {
    ...
    },
    {
      ...
      color: 'blue',
      icon: `${base}/feature_icons/protect_revenue.png`,
      examples: [
        {
    ...
    },
    {
      ...
      color: 'amber',
      icon: `${base}/feature_icons/reduce_costs.png`,
      examples: [
        {
    ...
    },
    {
      ...
      color: 'red',
      icon: `${base}/feature_icons/avoid_costs.png`,
      examples: [
        {
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-5xl mx-auto mb-8">
          <div class="p-6 rounded-lg border border-gray-200">
            <div class="flex items-center gap-3 mb-4">
              <img src="{base}/feature_icons/increase_revenue.png" alt="Increase Revenue" class="w-8 h-8" />
          ...
          <div class="p-6 rounded-lg border border-gray-200">
            <div class="flex items-center gap-3 mb-4">
              <img src="{base}/feature_icons/protect_revenue.png" alt="Protect Revenue" class="w-8 h-8" />
          ...
          <div class="p-6 rounded-lg border border-gray-200">
            <div class="flex items-center gap-3 mb-4">
              <img src="{base}/feature_icons/reduce_costs.png" alt="Reduce Costs" class="w-8 h-8" />
          ...
          <div class="p-6 rounded-lg border border-gray-200">
            <div class="flex items-center gap-3 mb-4">
              <img src="{base}/feature_icons/avoid_costs.png" alt="Avoid Costs" class="w-8 h-8" />
