            ...
            <div class="bg-white border border-gray-200 rounded-xl p-6">
              ...
              <ul class="space-y-4">
                <li class="flex items-center text-gray-700">
                  ...
                  <span class="text-lg">Gain a clear, objective view of automation and outsourcing costs</span>
                </li>
                <li class="flex items-center text-gray-700">
                  <div class="w-6 h-6 rounded-full bg-secondary/10 flex items-center justify-center mr-3">
                    <svg class="w-4 h-4 text-secondary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <span class="text-lg">Justify operational investments to your manager, CTO, or finance team</span>
                </li>
                <li class="flex items-center text-gray-700">
                  <div class="w-6 h-6 rounded-full bg-secondary/10 flex items-center justify-center mr-3">
                    <svg class="w-4 h-4 text-secondary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <span class="text-lg">Compare cost models to identify the best long-term approach</span>
                </li>
              </ul>
            </div>
          </div>
