            ...
            <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4">
              ...
              <div>
                ...
                <p class="text-base sm:text-lg text-gray-600 mt-2">
                  Quantify the business impact of a feature by evaluating how it generates revenue, protects revenue, reduces costs, or avoids costs. Get clear ROI and break-even analysis to support your decisions.
                </p>
              </div>
            </div>
        ...
        <div class="flex justify-center">
          <div class="bg-secondary/10 rounded-lg p-6 max-w-2xl w-full">
            ...
            <p class="text-gray-600 text-center">
              We're working hard to bring you a comprehensive Feature Value Calculator. This tool will help you:
            </p>
            <ul class="mt-4 space-y-2">
              <li class="flex items-center text-gray-700">
                ...
                Calculate value across multiple objectives
              </li>
              <li class="flex items-center text-gray-700">
                <div class="w-6 h-6 rounded-full bg-secondary/10 flex items-center justify-center mr-3">
                  <svg class="w-4 h-4 text-secondary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <li class="flex items-center text-gray-700">
                ...
                Visualize ROI and break-even analysis
              </li>
              <li class="flex items-center text-gray-700">
                <div class="w-6 h-6 rounded-full bg-secondary/10 flex items-center justify-center mr-3">
                  <svg class="w-4 h-4 text-secondary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                Generate detailed value breakdowns
              </li>
            </ul>
          </div>
        </div>
